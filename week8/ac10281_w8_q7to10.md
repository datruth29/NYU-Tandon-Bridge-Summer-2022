...
#### a) A fair die is rolled once. Let X be the random variable that denotes the sqquare of the number that shows up on the die. For example, if the die comes up 5, then X = 25. What is E[X]?
