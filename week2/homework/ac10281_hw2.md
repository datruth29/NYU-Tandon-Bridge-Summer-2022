...
Each statement below involves odd and even integers. An odd integer is an integer that can be expressed as , where  is an integer. An even integer is an integer that can be expressed as , where  is an integer.
