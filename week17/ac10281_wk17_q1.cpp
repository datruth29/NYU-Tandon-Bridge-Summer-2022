...
void RBT<T>::balanceTree(RBTNode<T> *&point)
{
    ...
    */
    ...
    // Check that grandparent exists and that it's read
    if(grandparent && getColor(parent) == RED)
    {
        // Rule 2. Check if uncle and inserted node is red
        // Flip their colours if they are
        ...
        // Rule 3: Check if Uncle is black or null
        if (uncle == nullptr || getColor(uncle) == BLACK)
        {
            // 3a. Check to see grandparent, parent, and node are lined up with each other
            ...
            // 3b. Check to see grandparent, parent, and node zig zag
...
template <class T>
void RBT_test(vector<T> test_case)
{
    RBT<T> test_tree;
...
int main() {
   ...
   //vector<int> test_case_1 = {15, 10, 5}; // Testing 
   //vector<int> test_case_2 = {5, 15, 10}; // Testing 
   //vector<int> test_case_3 = {5, 10, 15}; // Testing 
   //vector<int> test_case_4 = {0, 4, 2, 10}; // Testing 
   //
   //RBT_test(test_case_1);
   //cout << "\n\n";
   //RBT_test(test_case_2);
   //cout << "\n\n";
   //RBT_test(test_case_3);
   //cout << "\n\n";
   //RBT_test(test_case_4);
   //cin.get();
   // TEST
